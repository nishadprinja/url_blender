    ...
    if is_string_a_url(row[1]):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                'guitar', 'arrangement', 'fingerstyle', 'fingerstyle guitar', 'tik cover', 'guitar cover', 'guitarist', 'funny', 'funny guitar', 'acoustic guitar', 'tabs', 'guitar music', 'Song', 'when you', "When you don't know a single chord", 'but you need to impress new friends', 'to impress', 
                ...
                'bret', 'hart', 'best', 'athletic', 'moves', 'tribute', 'hit', 'man', 'hitman', 'athlete', 'athleticism', 'speed', 'agility', 'high', 'risk', 'taking', 'top', 'maneuvers', 'wwf', 'wwe', 'stampede', 'wrestling', 'ecw', 'pro', 'professional', 'sports', 'entertainer', 'entertainment', 'aerial', 'japan', 
                ...
                'system', 'down', 'soad', 'system of a down', 'daron', 'malakian', 'serj', 'tankian', 'john', 'dolmayan', 'shavo', 'odadjian', 'scars', 'broadway', 'north', 'kingsley', 'these', 'grey', 'men', 'armenia', 'yerevan', 'music', 'live', 'performance', 'rare', 'stage', 'song', 'scars on broadway', 'north kingsley', 'these grey men', 'full', 'velvet', 'hammer', 'california', 'los', 'angeles', 'show', 'concert', 'interview', 'chop', 'suey', 'chop suey!', 'isolated', 'vocals', 
                ...
                'comedy', 'comedy shorts', 'funny moments', 'videos to laugh', 'funny shorts', 'comedy club', 'stand-up', 'Dad', 'father', 'son', 'movie', 'cinematic', 'dads', 'sons', 'Michael', 'Michael Jackson', '80s', 'icons', 'MTV', 'we are the world', 'backstage', 'recording', 'new york city', 'best coffee in nyc', 'new york coffee shops', 'new york', 'caffeine test', 'caffeine levels', 'test caffeine', 'coffee shops', 'caffeine mg', 'cold brew', 'coffee', 'caffeine', 'coffee in new york', 'nyc vlog', 
                'coffee in nyc', 'new york cafe', 'nyc coffee', 'espresso', 'caffeine dosage', 'fda', 'james hoffmann', 'artizan coffee', 'stardust coffee', 'astrocat app', 'caffeine tracker app', 'caffeine app', 'coffee app', 'Ryan Stiles', 'Colin Mochrie', 'best of ryan stiles', 'ryan and colin', 'ryan stiles colin mochrie', 'best of colin mochrie', 'whose line is it anyway', 'funniest ryan stiles moments', 'whose line ryan', 'best of whose line', 'ryan stiles top 10', 'top 10', 
                ...
                'youtube poop', 'intro meme', 'meme', 'memes', 'dank memes', 'meme compilation', 'rickroll', 'dbz', 'dbz meme', 'goku', 'goku meme', 'kakarot', 'vegeta', 'kakarot meme', 'dragonball', 'dragonball z', 'dragonball z meme', 'vegeta meme', 'frieza meme', 'Superstars', 'raw', 'smackdown', 'afterburn', 'nxt', 'ppv', 'pay per view', 'divas', 'Classic Rock', 'microphone mayhem', 'the Great One', 'Stone Cold Steve Austin', 'Stone Cold', 'Undertaker', 'Hell in a Cell', 'Monday Night Raw', 'spiderman', 'tobey', 'maguire', 'bully', 'mcu', 'mighty morphin power rangers', 'power rangers', 'power rangers movie', '90s TV shows', '90s', 'nostalgia', 'guitar', 'guitar cover', 
                ...
                'pokedex animated', 'marvel', 'mcu', 'eternals', 'antman', 'spider-man', 'marvel cinematc universe', 'captain', 'captain marvel', 'the marvels', 'marvels', 'ant-man', 'ant man', 'Kurt cobain', 'Nirvana', 'Dave grohl', '10 hours', 'tenacious d', 'tribute', 'kyle gass', 'King Jables', 'Jables', 'Jablinski', 'Jablinski Games', 'IPad', 'Halloween Costume', 'fake blood', 'Halloween', 'iPad2', 'Facetime', 'videochat', 'see through', 'illusion', 'simple', 'mobile mifi', 'duct tape', 'torso', 'costume', 'bloody', 'gory', 'Mark Rober', 'NASA', 'engineer', 'Mercedes', 'Fuel Cell', 'Electric Car', 'Publicity Stunt', 'Invisible', 'Video trick', 
                ...
                'GTA', 'san andreas', 'gta 3', 'Banned', 'Commercial', 'Heineken', 'Beer', 'Jennifer', 'Aniston', 'NIRVANA', 'nirvana unplugged', 'SiriusXM', 'Sirius XM', 'Sirius', 'SXM', 'puddle of mudd', 'puddle of mudd live performance', 'Chris Van Vliet', 'CVV Clips', 'Guitar Hero', 'comedy', 'central', 'backstage stories', 'wrestling stories', 'wrestling interview', 'attitude era', 'ya fantasy books', 'ya fantasy series', 'ya fantasy book recommendations', 'ya fantasy parody', 'ya distopian', 'ya dystopian', 'Drake Bell', 'Drake and Josh', 'sonic', 'plush', 'amazon', 'sonic the hedgehog', 'game console', 'switch', 'wii', 'iron chef', 'funny skit', 'making fun','dunkey', 'dunkey kingdom hearts', 'kingdom hearts', 'kingdom hearts explained', 'kingdom hearts recap', 'kingdom hearts story explained', 'kingdom hearts story recap', 'kingdom hearts dunkey', 
                ...
                'Self Defense', 'Self Defence', 'MMA', 'Tae kwon do', 'trapping', 'training', 'fighter', 'martial artist', 'fighting', 'brazillian jiu jitsu', 'jiu jitsu', 'stay safe', 'protection', 'military', 'self confidence', 'conflict management', 'personal defense', 'mixed martial arts', 'martial arts training', 'wing chun', 'muay thai', 'martial arts', 'Kung fu', 'personal development', 'boxing', 'bjj', 'karate', 'judo', 'assault', 'protect yourself', 'violence', 'empowerment', "women's self defense", 'safety', 'attack', 'Kevin goat', 'situational awareness', 'stay safe', 
                'great white shark', 'shark', 'aquarium', 'great white sharks', 'sharks', 'great white shark in aquarium', 'great white sharks in aquariums', 'great white shark in captivity', 'fish', 'animal', 'animals', 'animal shorts', 'nature', 'animal planet', 'communication skills', 'how to improve your communication', 'communication tips', 'how to become a better communicator', 'how to improve your voice', 
                'stages of having a crush', 'crush', 'stages of love', 'having a crush', 'dating', 'love', 'relationships', 'relationship', 'crush on someone', 'psych2go', 'stage', 'crushing', '5 stages', '6 stages of having a crush', 'psych2go crush', 'psych2go love', 'in a relationship', 'signs of a crush', 'feelings', 'emotions', 'mental health', 'psychology', 'boyfriend', 'girlfriend', 'dating advice', 'relationship advice', 'stages of relationship', 'stages of a relationship', 'romantic', 'mystery of love', 'attraction', 'romantic attraction', 'fall in love', 
                ...
                'how peanut butter is made', 'cooking', 'food', 'chicken', 'fried chicken', 'orange chicken', 'easy recipe', 'auto', 'auto repair', 'car', 'car diy', 'car repair', 'cars', 'how to', 'mechanic', 'repair', 'car review', 'car theft', 'car thief', 'how cars are stolen', 'how to keep car from being stolen', 'most stolen', 'most stolen cars', 'motor vehicle theft', 'stolen', 'stolen car', 'stolen cars', 'stolen cars caught on camera', 'stolen cars found', 'education', 'philosophy', 'talk', 'self', 'improvement', 'big questions', 'love', 'wellness', 'mindfullness', 'psychology', 'how', 'hack', 'relationship', 'relationship advice', 'relationship repair', 'couples', 'communication', 'trust', 'intimacy', 'honesty', 'self-improvement', 'breakup', 'divorce', 'infidelity', 'jealousy', 'conflict', 
